...
![Python コードハイライト](screenshots/pc-code-python.png)

![C# コードハイライト](screenshots/pc-code-csharp.png)

![Go コードハイライト](screenshots/pc-code-go.png)

### タグクラウドスタイル

カテゴリーを記事数に応じて視覚的に表示します。記事数が多いカテゴリーほど大きく表示されるため、ブログの主要テーマが一目でわかります。

<!-- カテゴリー表示のスクリーンショットは取得できていないため、画像を削除 -->
...
<!-- アーカイブ表示のスクリーンショットは取得できていないため、画像を削除 -->
...
<!-- コメントセクションのスクリーンショットは取得できていないため、画像を削除 -->
...
<!-- 関連記事表示のスクリーンショットは取得できていないため、画像を削除 -->
