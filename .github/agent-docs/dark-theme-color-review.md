...
### 3.2 案B: バランス調整（Dimmed寄りに + テキスト色も含めた総合調整）
...
| `--text-body`（参考） | `#ffffff` | **`#e6edf3`**（検討） | 過剰コントラストの緩和 |

**コントラスト検証**:

| 組み合わせ | 比率 | 判定 |
|-----------|------|------|
| bg `#1a1f27` vs text `#e6edf3` | 14.00:1 | AA OK ✅ |
| bg `#1a1f27` vs text `#ffffff` | 14.00:1 | — |
