...
* カテゴリーの各要素をタグクラウド風味に表示します。タグクラウド風味とは、各カテゴリーの記事数(カテゴリー名の後ろに表示されている)に応じて、フォントサイズを変えます。カテゴリーの数が多いほど、フォントサイズは大きくなります。カテゴリーの数が少ないほど、フォントサイズは小さくなります。
  * カテゴリーの数が少ない場合、フォントサイズは小さくなりますが、フォントサイズは最小でも0.8emにします。カテゴリーの数が少ない場合、フォントサイズは大きくなりますが、フォントサイズは最大でも2.0emにします。
  * 各カテゴリーを丸囲みで表示します。丸囲みの色は背景色、ホバー時にボタンホバー用背景色をつけます。
  * 以上のタグクラウドの実装はSCSSで実装します。JavaScriptで実装しないでください。
